...
class ProvenanceCapTests(unittest.TestCase):
    ...
    and reads T3_VALIDATED. It is still only a lead, because the gates
    ...
    def _score(self, prereg):
        ...
        if prereg.get("in_sample_by_construction") and tier != "T0_REJECTED":
            tier = "T1_HYPOTHESIS"
        self.assertIn(tier, ("T1_HYPOTHESIS", "T3_VALIDATED"))
        return tier
    ...
    def test_ordinary_hypotheses_are_not_capped(self):
        self.assertEqual(self._score({}), "T3_VALIDATED")

...
In the August 28 baseline, modeled costs were about **$1,599.98**, roughly **5.38% of the net loss magnitude**. Most of this cohort’s loss already existed in gross results. Its exits were **514 time exits (79.1%), 90 stops (13.8%), and 46 targets (7.1%)**. The old diagnostic “time” category does not reliably separate thesis expiry, session truncation, and every data-continuity circumstance, so that decomposition needs a current replay. Nevertheless, exit geometry and timing deserve at least as much attention as entry thresholds.
